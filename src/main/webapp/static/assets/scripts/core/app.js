...
var App = function () {
    ...
    var handleFullScreenMode = function() {
        ...
        function toggleFullScreen() {
          if (!document.fullscreenElement &&    // alternative standard method
              !document.mozFullScreenElement && !document.webkitFullscreenElement &&  !(document.msFullscreenElement != null)) {  // current working methods
            if (document.documentElement.requestFullscreen) {
              ...
              $("#trigger_fullscreen").html('还原&nbsp;<i class="fa fa-arrows-alt" style="width: 6px;"></i>');
          } else {
            if (document.exitFullscreen) {
              ...
              $("#trigger_fullscreen").html('全屏&nbsp;<i class="fa fa-arrows-alt" style="width: 6px;"></i>');
          }
        }
        ...
        $('#trigger_fullscreen').click(function() {
            ...
            if($.browser.msie10 || $.browser.msie9 || $.browser.msie8 || $.browser.msie7 || $.browser.msie6){
                alert("当前浏览器不支持全屏操作！");
            }else{
                toggleFullScreen();
            }
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "static/assets/css/themes/" + color_ + ".css");
            if ($.cookie) {                
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="static/assets/img/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="static/assets/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="static/assets/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
