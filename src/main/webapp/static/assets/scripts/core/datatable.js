            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {  // language settings
                        "sProcessing": '<img src="static/assets/img/loading-spinner-grey.gif"/><span>&nbsp;&nbsp;读取中...</span>',
                        "sLengthMenu": "<span class='seperator'>|</span>每页 _MENU_ 条记录",
                        "sInfo": "<span class='seperator'>|</span>找到 _TOTAL_ 条记录",
                        "sInfoEmpty": "没有记录",
                        "sGroupActions": "_TOTAL_ records selected:  ",
                        "sAjaxRequestGeneralError": "请求失败, 内部错误!",
                        "sEmptyTable": "没有记录",
